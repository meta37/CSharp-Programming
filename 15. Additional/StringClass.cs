...
namespace _15._Additional
{
    internal class StringClass
    {
        ...
        void Main3()
        {
            ...
            Console.WriteLine("abc" + 123 + "def" + 456);     // "abc123def456" 문자열을 얻어내기 위해 "abc", "def", "abc123", "abc123def" 이 가비지 발생

            // string Format : 가비지컬렉터에 부담되지 않도록 설계된 문자열 사용방법
            Console.WriteLine(string.Format("abc{0}def{1}", 123, 456));

            // string 보간 : string.Format의 간단한 표현방식
            Console.WriteLine($"abc{123}def{456}");
